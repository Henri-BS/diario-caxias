...
export function ProjectMockProfile({ params }: any) {
    ...
    const filterByProject = () => {
            return eventMock.filter(event => event.projectTitle === params);
    };


    const eventsByProject = filterByProject();
                            ...
                            <div className="relative flex flex-col sm:flex-row xl:flex-col items-start">
                                <div className="order-1 sm:ml-6 xl:ml-0">
                                    ...
                                    <div className="prose prose-slate prose-sm text-slate-600 mt-5">
                                        ...
                                        <p className="flex flex-row items-center text-gray-700 text-lg gap-2"><FaIcons.FaNewspaper /> Notícias relacionados: <b>{0}</b></p>
                                    </div>
                                </div>
