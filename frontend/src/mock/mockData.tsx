export const projectMock = [
    {
        ...
        projectDescription: 'Os projetos urbanos que combinam casas e áreas de produção de alimentos solucionam duas demandas de quem vive em cidades: um contato maior com a natureza e a proximidade com a produção de alimentos – o que gera menos impacto ambiental e, muitas vezes, acesso à comida produzida de maneira mais saudável e sustentável. Nesta publicação, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas aos Agrobairros em Caxias',
        projectImage: 'https://www.graphikmaquetas.com.ar/val8.jpg',
        createdDate: '26/10/2024',
        userId: 1,
        username: 'Jack Azevedo'
    },
    {
        id: 2,
        projectTitle: 'Coleta e Filtragem de Água',
        projectDescription: 'Os projetos de coleta e filtragem de água visão prover a criação de estruturas que possam sar facilmente instaladas em diversos locais da cidade permitindo também que a água da chuva seja coletada, filtrada e armazenada para os períodos mais secos, auxiliando na gestão sustentável da água. Neste projeto, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas a Coleta e Filtragem de Água em Caxias',
        projectImage: 'https://img.freepik.com/premium-vector/water-drop-shape-blue-water-drop-logo-design-water-oil-drop_275352-810.jpg',
        createdDate: '26/10/2024',
        userId: 2,
    ...
    },
    {
        ...
        projectDescription: 'Neste projeto, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas ao Reflorestamento em Caxias',
        projectImage: 'https://sitesustentavel.com.br/wp-content/uploads/2019/05/sh_reflorestamento_790269046.jpg',
        createdDate: '26/10/2024',
        userId: 2,
        username: 'Ryan Azevedo'
    },
    {
        id: 4,
        projectTitle: 'Arquitetura Acessível e Sutentável',
        projectDescription: 'Os projetos de moradia que envolvem uma arquitetura de preço acessível, uma alta velocidade na produção e um baixo impacto no meito ambiente podem ser uma solução prática para o problema de pessoas em situação de vunerabilidade com moradia. Neste projeto, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas a Arquitetura Acessível e Sustentável em Caxias',
        projectImage: 'https://www.aubicon.com.br/wp-content/uploads/2021/03/04_arq_sustentavel_blog_15.jpg',
        createdDate: '26/10/2024',
        userId: 3,
    ...
    },
    {
        ...
        projectDescription: 'Os projetos de reurbanização são iram pertimitir a reorganização do espaço urbano e a implantação da infraestrutura necessária em um determinado contexto. Nesta publicação, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas a Reurbanização em Caxias',
        projectImage: 'https://files.prokerala.com/news/photos/imgs/1024/telangana-mobility-valley-1522957.jpg',
        createdDate: '26/10/2024',
        userId: 4,
        username: 'Anna Rocha'
    },
    {
        id: 6,
        projectTitle: 'Presevação de Bairros Históricos',
        projectDescription: 'Neste projeto, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas a Preservação de Bairros Históricos em Caxias',
        projectImage: 'https://3.bp.blogspot.com/-2VlbdH8dBu0/Ugws24hLLlI/AAAAAAAABD8/1UDgWHfQjg4/s1600/SAM_2660.JPG',
        createdDate: '26/10/2024',
        userId: 6,
    ...
    {
        id: 7,
        projectTitle: 'Desenvolvimento Cultural',
        projectDescription: 'Neste projeto, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas ao Desenvolvimento Cultural em Caxias',
        projectImage: 'https://maken.wikiwijs.nl/generated/s960x720_a8b0a9ba449553dffd7e56bcca7286970445c6e3.jpg',
        createdDate: 26/10/2024,
        userId: 7,
    ...
    {
        id: 9,
        projectTitle: 'Literatura Regional',
        projectDescription: 'Neste projeto, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas a Literatura Regional em Caxias',
        projectImage: 'https://www.lifeder.com/wp-content/uploads/2020/03/concepto-literatura-libros-min-1.jpg',
        createdDate: '26/10/2024',
        userId: 13,
    ...
    },
    {
        ...
        projectDescription: 'Neste projeto, veja mais sobre quais conteúdos didáticos, eventos e atividades que estão relacionadas as Energias Renováveis em Caxias',
        projectImage: 'https://sitesustentavel.com.br/wp-content/uploads/2019/05/sh_energia-renovavel_553614883.jpg',
        createdDate: '26/10/2024',
        userId: 2,
        username: 'Ryan Azevedo'
    },
...
export const eventMock = [
    {
        id: 1,
        eventTitle: 'Seminário sobre a distribuição de alimentos nos Agrobairros em Caxias',
        eventDescription: 'Este evento trata-se de um seminário sobre a distribuição de alimentos nos Agrobairros em Caxias. O Evento reunirá especialistas, agricultores locais, residentes nos bairros envolvidos e interessados na temática para discutir as práticas e políticas que possam garantir uma entrega eficiente e justa de alimentos nas áreas dos Agrobairros Caxienses. Será uma oportunidade para aprender, trocar experiências e buscar soluções inovadoras para melhorar a cadeia de distribuição, impactando positivamente a segurança alimentar e a qualidade de vida da comunidade.',
    ...
    {
        id: 2,
        eventTitle: 'Atividade prática para estabelecimento de hortas comunitárias no bairro Nova Caxias',
        eventDescription: 'O evento é uma iniciativa que visa transformar espaços urbanos subutilizados em hortas comunitárias produtivas no bairro Nova Caxias. Este evento prático reunirá moradores do bairro para colaborar na criação de hortas que não só fornecerão alimentos saudáveis, mas também promoverão a integração social, a educação ambiental e a sustentabilidade.',
    ...
    {
        id: 3,
        eventTitle: 'Palestra sobre riscos e cuidados com pragas nas hortas em Agrobairros de Caxias',
        eventDescription: 'Este evento é uma iniciativa educativa voltada para os moradores de Agrobairros que desejam aprender mais sobre como proteger suas hortas das pragas mais comuns. Este evento visa fornecer conhecimentos práticos e teóricos sobre a identificação, prevenção e controle de pragas, promovendo a conscientização de uma agricultura urbana mais saudável e sustentável.',
    ...
    {
        id: 5,
        eventTitle: 'Criação de soluções para automatizar a produção de alimentos nos Agrobairros em Caxias',
        eventDescription: 'O evento objetiva reunir especialistas, agricultores urbanos e entusiastas da tecnologia para discutir e desenvolver soluções inovadoras que automatizem a produção de alimentos nos Agrobairros de Caxias. Este evento busca promover a adoção de tecnologias avançadas para aumentar a eficiência, sustentabilidade e produtividade das hortas urbanas.',
    ...
    {
        id: 6,
        eventTitle: 'Videoconfêrencia sobre plantio de cereais na Vila Conquista de Caxias',
        eventDescription: 'Este evento promove o compartilhamento de conhecimentos e práticas sobre o cultivo de cereais em ambientes urbanos. Este evento online reunirá especialistas, agricultores urbanos e interessados para discutir técnicas, desafios e inovações no plantio de cereais, promovendo a sustentabilidade e a segurança alimentar na Vila Conquista',
    ...
    {
        id: 7,
        eventTitle: 'Produção de relatórios sobre benefícios dos Agrobairros na economia de Caxias',
        eventDescription: 'O evento que conta com a participação de especialistas, gestores públicos, economistas e membros da comunidade busca analisar e documentar atráves da produção de relatórios os impactos econômicos positivos dos Agrobairros na cidade de Caxias. Este evento busca promover a compreensão e a valorização da agricultura urbana como um motor de desenvolvimento econômico.',
        eventImage: 'https://cdn0.iconfinder.com/data/icons/business-situations-flat-1/64/annual-report-graph-summary-company-1024.png',
    ...
    {
        id: 8,
        eventTitle: 'Seminário sobre a conservação de alimentos nos Agrobairros em Caxias',
        eventDescription: 'Este evento é um seminário sobre a Conservação de Alimentos em Agrobairros é uma iniciativa educativa que objetiva capacitar os moradores e agricultores urbanos sobre as melhores práticas e tecnologias para a conservação de alimentos. Este evento reunirá especialistas, técnicos e a comunidade para discutir métodos eficazes de preservação, garantindo a qualidade e a segurança dos alimentos produzidos nos Agrobairros.',
        eventImage: 'https://cdn1.iconfinder.com/data/icons/business-vivid-vol-2/256/Seminar-1024.png',
    ...
    {
        id: 9,
        eventTitle: 'Atividade prática para estabelecimento de hortas comunitárias no bairro Trizidela',
        eventDescription: 'O evento é uma iniciativa que visa transformar espaços urbanos subutilizados em hortas comunitárias produtivas no bairro Trizidela. Este evento prático reunirá moradores do bairro para colaborar na criação de hortas que não só fornecerão alimentos saudáveis, mas também promoverão a integração social, a educação ambiental e a sustentabilidade.',
        eventImage: 'https://cdn2.iconfinder.com/data/icons/career-advancement-4/512/Practice-1024.png',
    ...
    {
        id: 10,
        eventTitle: 'Palestra sobre cuidados com agrotóxicos nas hortas em Agrobairros de Caxias',
        eventDescription: 'A palestra cuidados no uso de agrotóxicos nas hortas dos agrobairros de Caxias é um evento educativa destinado a informar e capacitar os moradores e agricultores urbanos sobre o uso seguro e responsável de agrotóxicos. Este evento visa promover a saúde, a segurança e a sustentabilidade nas práticas agrícolas dos Agrobairros.',
        eventImage: 'https://cdn2.iconfinder.com/data/icons/system-filled-outline/64/warning-danger-system-icon-512.png',
    ...
    {
        id: 11,
        eventTitle: 'Apresentação e debate dos dados periódicos sobre a distribuição de alimentos dos Agrobairros em Caxias',
        eventDescription: 'O evento é uma oportunidade para os moradores, gestores públicos e interessados se reunirem para analisar e discutir os dados mais recentes sobre o desenvolvimento da distribuição de alimentos dos Agrobairros na cidade. Este evento visa promover a transparência, a participação comunitária e a tomada de decisões informadas com base em dados concretos.',
        eventImage: 'https://cdn-icons-png.flaticon.com/512/9912/9912471.png',
    ...
    {
        id: 12,
        eventTitle: 'Criação de soluções para capacitar moradores no manuseio de hortas nos Agrobairros em Caxias',
        eventDescription: 'O evento objetiva reunir especialistas, agricultores urbanos e entusiastas da tecnologia para discutir e desenvolver soluções inovadoras para capacitação de moradores no manuseio de hortas nos Agrobairros de Caxias. Este evento busca promover a adoção de novas ideias para aumentar a eficiência, sustentabilidade e produtividade das hortas urbanas.',
        eventImage: 'https://cdn0.iconfinder.com/data/icons/smart-technology-malibu-volume-1/128/intelligent-power-512.png',
    ...
    {
        id: 13,
        eventTitle: 'Videoconfêrencia sobre plantio de cereais no Morro do Alecrim de Caxias',
        eventDescription: 'Este evento promove o compartilhamento de conhecimentos e práticas sobre o cultivo de cereais em ambientes urbanos. Este evento online reunirá especialistas, agricultores urbanos e interessados para discutir técnicas, desafios e inovações no plantio de cereais, promovendo a sustentabilidade e a segurança alimentar na Vila Conquista',
        eventImage: 'https://cdn-icons-png.flaticon.com/512/4730/4730760.png',
    ...
    {
        id: 14,
        eventTitle: 'Produção de relatórios sobre o auxílio dos Agrobairros na segurança alimentar de Caxias',
        eventDescription: 'O evento que conta com a participação de especialistas, gestores públicos, economistas e membros da comunidade busca analisar e documentar atráves da produção de relatórios os impactos positivos dos Agrobairros na segurança alimentar da cidade de Caxias. Este evento busca promover a compreensão e a valorização da agricultura urbana como um auxiliar na vida dos mais vulneráveis.',
        eventImage: 'https://cdn0.iconfinder.com/data/icons/business-situations-flat-1/64/annual-report-graph-summary-company-1024.png',
...
export const postMock = [
    ...
    },
    {
        ...
        createdDate: '26/10/2024',
        postImage: 'https://brcooperativo.com.br/wp-content/uploads/2022/11/reflorestamento.jpg',
        userId: 2
    },
    {
        id: 3,
        ...
        createdDate: '26/10/2024',
        postImage: 'https://www.drevostavitel.cz/galerie/clanky/2075/gallery/kontejnerove-domy-57635.jpg',
        userId: 3
    },
    {
        id: 4,
        ...
        createdDate: '26/10/2024',
        postImage: 'https://img.freepik.com/fotos-premium/relogio-de-bolso-vintage-fundo-vintage-conceito-de-historia-do-tempo_564276-1815.jpg',
        userId: 4
    },
    {
        id: 5,
        ...
        createdDate: '26/10/2024',
        postImage: 'https://tec.mx/sites/default/files/styles/header_full/public/2021-02/top-energy-una-alternativa-en-energias-verdes.jpg?h=920929c4&itok=wPnRvFyV',
        userId: 9
    },
    {
        id: 6,
        ...
        createdDate: '26/10/2024',
        postImage: 'https://wallpaperboat.com/wp-content/uploads/2020/12/14/63668/presentation-economy-11.jpg',
        userId: 10
    },
    {
        id: 7,
        ...
        createdDate: '26/10/2024',
        postImage: 'https://www.ecoeficientes.com.br/new/wp-content/uploads/2013/03/Untitled30.png',
        userId: 11
    },
    {
        id: 8,
        ...
        createdDate: '26/10/2024',
        postImage: 'https://amazoniareal.com.br/wp-content/uploads/2016/12/SLIDE-QUEIMADAS-PARA-DESMATAMENTO-AMAZONIA_FOTO-RODRIGO-BALEIA-GREENPEACE-1024x683.jpg',
        userId: 12
    },
    {
        id: 9,
