    ...
    return (
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-xl transition duration-700 hover:scale-105">
            <div className="flex flex-col h-48 items-center pb-10">
                <img className="w-24 h-24 mb-3 rounded-full shadow-xl" src={user.userImage ?? "https://cdn1.iconfinder.com/data/icons/basic-ui-element-2-2-line/512/Basic_UI_Elements_-_2.1_-_line-11-256.png"} />
