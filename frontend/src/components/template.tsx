        ...
        return (
            ...
            <Link href={`/usuarios/${userId}`}>
                <Popover title={user?.username} content={user?.username} className="bg-zinc-700 text-gray-100 p-1 rounded-lg" trigger="hover" arrow={false}>
                    <img src={user?.userImage ? user?.userImage : "https://cdn1.iconfinder.com/data/icons/basic-ui-element-2-2-line/512/Basic_UI_Elements_-_2.1_-_line-11-256.png"} className="h-12 w-12 rounded-full bg-[#ffffffbe] cursor-point border border-gray-100 transition duration-600 hover:border-blue-500" />
                </Popover>
            </Link>
        )
    }
            ...
            <header className="border-b border-gray-500 fixed w-full backdrop-blur-sm bg-[#171717ec] text-white py-6 z-40 top-0">
                <div className="mx-auto flex justify-between items-center px-2 gap-4">
                    ...
                    <div className="flex  gap-2 items-center text-gray-300">
                        <Dropdown label={<FaIcons.FaPlus />} gradientDuoTone="greenToBlue">
                            <div >
                        ...
                        <RenderIf condition={!userSession}>
                            <Link href={"/login"} >
