    ...
    return (
        <nav>
            <ul className="flex items-center -space-x-px h-10 text-base">
                ...
                <li>
                    <button onClick={() => onPageChange( pagination.page.number + 1)} className="cursor-pointer flex items-center justify-center px-3 h-10 leading-tight text-gray-500 bg-white border border-gray-600 rounded-e-lg hover:bg-gray-100 hover:text-gray-700">
