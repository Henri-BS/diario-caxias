...
export const ProjectCard = ({ project }: ProjectProps) => {
    return (
        <Link href={`/projetos/${project.id}`} className="flex flex-col max-h-70 items-center bg-zinc-100 border border-zinc-300 rounded-xl shadow md:flex-row md:max-w-full hover:bg-zinc-300">
